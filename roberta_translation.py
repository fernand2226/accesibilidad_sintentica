...
tokenizer = RobertaTokenizerFast.from_pretrained("BPE_SELFIES_PubChem_shard00_160k/", force_download=True)
...
# Loading the RoBERTa Tokenizer
tokenizer = RobertaTokenizerFast.from_pretrained("BPE_SELFIES_PubChem_shard00_160k/", force_download=True,  max_len=MAX_LEN)
# Setting the BOS and EOS token
tokenizer.bos_token = tokenizer.cls_token
tokenizer.eos_token = tokenizer.sep_token
...
roberta_shared = EncoderDecoderModel.from_encoder_decoder_pretrained("BPE_SELFIES_PubChem_shard00_160k/", "BPE_SELFIES_PubChem_shard00_160k/", force_download=True, tie_encoder_decoder=True)
...
tokenizer = RobertaTokenizerFast.from_pretrained(tokenizer_folder, force_download=True)
model = EncoderDecoderModel.from_pretrained(model_folder, force_download=True)
